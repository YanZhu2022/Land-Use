...
File purpose:
Initialiser for all logging in land_use
"""
# Builtins
import logging
...
def get_logger(logger_name: str,
               log_file_path: lu.PathLike = None,
...
def check_child_logger(logger_name: str) -> None:
    ...
    if logger_name.strip().split('.')[0] != lu.PACKAGE_NAME:
        raise ValueError(
...
def get_file_handler(log_file: lu.PathLike,
                     fh_format: str = None,
                     datetime_format: str = None,
